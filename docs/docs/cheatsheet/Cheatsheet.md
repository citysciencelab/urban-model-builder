...
| ----------- | ----------- |----------- | ----------- |
| ![stock](./img/stock.png)  | SD     | <ol><li>Akkumulierte Größen bzw. Werte, die sich im Laufe der Zeit ansammeln oder abbauen</li><li>Speichert aktuellen Wert zu unterschiedlichen Berechnungszeitschritten </li><li>Ändert sich durch Zuflüsse (Inflows) oder Abflüsse (Outflows)</li></ol>  | Bevölkerungszahl, Wasserstand, Energieinhalt | 
| ![flow](./img/flow.png)  | SD     | <ol><li>Beschreiben die Geschwindigkeit, mit der sich ein Bestand aufbaut oder abbaut</li><li>Verändern den Stock, aber speichern selbst keine Werte</li><li>Können von anderen Variablen abhängen</li></ol> | Geburtenrate, Wasserzufluss, Energieverbrauch | 
| ![OGC API feature](./img/API.png)  | Common     | <ol><li>Moderner Standard des Open Geospatial Consortium (OGC)</li><li>Bereitstellung und Abfrage von Geodaten über Webschnittstellen</li><li>Datensätze aus Geoportal über das Masterportal Hamburg</li></ol> | Volkszählungen, Bezirksdaten, Infrastruktur | 
| ![variable](./img/variable.png)  | Common     | <ol><li>Größenveränderliche Einflussfaktoren</li><li>Keine Speicherfunktion der Werte</li><li>Beeinflussen andere Berechnungsgrößen</li></ol>|  | 
| ![converter](./img/converter.png)  | Common     | <ol><li>Führt eine Berechnung, Transformation oder Ableitung aus anderen Variablen oder Konstanten durch</li><li>Ähnlich wie Hilfsvariable und speichert keine Werte, sondern wird bei jeder Simulationszeit neu berechnet</li><li>Stellt grafisch Input-Output Relationen dar</li></ol>|  |
| ![folder](./img/folder.png)  | Common    | <ol><li>Strukturgebendes Element, welches die Organisation eines Modells vereinfacht</li><li>Ausgewählte Modellteile können gesammelt, gruppiert und bewegt werden</li></ol>|  |
| ![state](./img/state.png)  | ABM     | <ol><li>Bezeichnet Zustand von aktueller Situation oder Konfiguration eines Agenten, die sein Verhalten beeinflusst</li><li>Wechseln von einem State in einen anderen, ausgelöst durch Regeln, Wahrscheinlichkeiten oder Umwelteinflüsse</li></ol>| Zuhause, Auf der Arbeit, In Quarantäne |
| ![transition](./img/transition.png)  | ABM     | <ol><li>Bezeichnen Übergänge zwischen den Zuständen eines Agenten</li><li>Wann und unter welchen Bedingungen soll Agent von einem Zustand in einen anderen wechseln?</li></ol>| Von gesund zu infiziert, von unentschlossen zu überzeugt, Umzug in eine andere Stadt |
| ![action](./img/action.png)  | ABM     | <ol><li>Konkrete Handlungen, die ein Agent während eines Zustandes oder bei einem Zustandswechsels (Transitions) ausführt</li><li>Beschreiben operationale Verhaltensregeln, wie beispielsweise sich bewegen, mit anderen Agenten interagieren, Ressourcen verbrauchen etc.</li></ol>| sich impfen lassen, Nächste Fahrradstation suchen, Andere Agenten beeinflussen |
| ![agent](./img/agent.png)  | ABM     | <ol><li>Ist autonome Entität, die eigene Zustände, Eigenschaften und Verhaltensregeln besitzt</li><li>Kann mit ihrer Umwelt und anderen Agenten interagieren</li><li>Können eigenständige Entscheidungen treffen, zustandsabhängig handeln, sich verändern und lokal interagieren</li></ol>| Auto im Straßenverkehr, Konsument im Markmodell, Maschine in einer Fabrik |
| ![population](./img/population.png)  | ABM     | <ol><li>Gesamtheit aller Agenten eines bestimmten Typs innerhalb eines Modell</li><li>Kollektive Menge an Agenten haben gemeinsame Eigenschaften oder Verhaltenstypen</li></ol>| Bewohner in einer Stadt, Fahrzeuge auf einer Straße, Bäume im Quartier |
  </TabItem>
...
| ----------- | ----------- |----------- |
| ![NaviBar](./img/NaviBar.png)  | **Navibar**    | <ol><li>Zurück zum Homescreen</li><li>Liste meiner Modelle</li><li>Liste öffentlicher Modelle</li><li>Rechtliche Dokumente</li><li>Übersetzung(DE/EN)</li><li>Benutzerkontoname</li><li>Abmeldung</li></ol>
| ![ListeMeinerModelle](./img/ListeMeinerModelle.png)  | Meine Modelle   | <ol><li>Suchfunktion</li><li>Filterfunktion</li><li>Neues Modell erstellen</li><li>Modell öffnen</li><li>Modellname & -Beschreibung bearbeiten</li><li>Modell löschen</li></ol>
| ![SideBar](./img/SideBar.png)  | **Sidebar**    | <ol><li>Modellinformationen</li><li>Szenario-Einstellungen</li><li>Versions-Einstellungen</li><li>Modell-Einstellungen</li></ol>
| ![ModellEinstellungen](./img/ModellEinstellungen.png)  | Modell Einstellungen    | <ol><li>Start des Simulationszeitraums</li><li>Länge des Simulationszeitraums</li><li>Zeitintervalle</li><li>Einheit der zeitlichen Dimension</li><li>Berechnungsalgorithmus</li><li>Globals & Makros</li></ol>
| ![ModellKlonen](./img/ModellKlonen.png)  | Modell klonen     | <ol><li>Neuer Modellname</li></ol>
| ![ModellTeilen](./img/ModellTeilen.png)  | Modell teilen    | <ol><li>E-Mailadresse des Empfängers</li><li>Zugeteilte Rolle</li></ol>
| ![ModellVeröffentlichen](./img/ModellVeröffentlichen.png)  | Modell veröffentlichen    | <ol><li>Versionstyp</li><li>Veröffentlichung als Modelserver Endpunkt</li><li>Notizen</li></ol>
| ![ActiveBar](./img/ActiveBar.png)  | **Activebar**    | <ol><li>Primitives</li><li>Simulation durchführen</li></ol>
| ![PrimitivesFenster](./img/PrimitivesFenster.png)  | Primitives     | <ol><li>11 Funktionsbausteine</li><li>Anpinnen-Funktion</li></ol>
| ![Simulationsergebnisse](./img/Simulationsergebnisse.png)  | Simulationsergebnisse     | <ol><li>Anzeige der Simulationsergebnisse in Linien- oder Streudiagramm</li><li>Anpinnen-Funktion</li><li>Geschwindigkeits-Einstellungen</li></ol>
![Canvas](./img/Canvas.png) | Canvas |  <ol><li>Arbeitsoberfläche für die Platzierung der Primitives</li><li>Primitives grafisch verbinden/Geistervariablen erstellen/löschen</li></ol>
| ![PrimitiveEinstellungsfenster](./img/PrimitiveEinstellungsfenster.png)  | Primitive-Einstellungsfenster    |  <ol><li>Einstellungen des jeweiligen Primitives</li><li>Schnittstelle & Szenario-Einstellungen</li><li>Validierung</li></ol>
| ![SzenarioEinstellungeninPrimitiveEinstellungsfenster](./img/SzenarioEinstellungeninPrimitiveEinstellungsfenster.png) ![SzenarioEinstellungen](./img/SzenarioEinstellungen.png)  | Szenario-Einstellungen     |  <ol><li>Parameter im Primitive-Einstellungsfenster</li><li>Szenario-Einstellungen in der Sidebar</li></ol>
